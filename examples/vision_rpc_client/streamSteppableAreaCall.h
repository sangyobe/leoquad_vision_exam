...
class StreamSteppableAreaCall : public dtCore::dtServiceCallerGrpc<ServiceType>::Call {
    using CallState = typename dtCore::dtServiceCallerGrpc<ServiceType>::Call::CallState;

public:
    StreamSteppableAreaCall(ServiceType::Stub *stub, grpc::CompletionQueue *cq, void *udata = nullptr);
...
private:
    ...
    std::unique_ptr<::grpc::ClientAsyncWriter<::dtproto::nav_msgs::SteppableAreaTimeStamped>> _responder;
