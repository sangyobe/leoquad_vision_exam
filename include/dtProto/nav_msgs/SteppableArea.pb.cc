...
PROTOBUF_CONSTEXPR SteppableArea::SteppableArea(
  ...
  , /*decltype(_impl_.unsteppables_)*/{}
  , /*decltype(_impl_.steppables_count_)*/0u
  , /*decltype(_impl_.unsteppables_count_)*/0u
...
static ::_pb::Metadata file_level_metadata_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto[2];
...
const uint32_t TableStruct_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::dtproto::nav_msgs::SteppableArea, _impl_.unsteppables_),
  PROTOBUF_FIELD_OFFSET(::dtproto::nav_msgs::SteppableArea, _impl_.unsteppables_count_),
  ~0u,  // no _has_bits_
...
static const ::_pbi::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, -1, sizeof(::dtproto::nav_msgs::SteppableArea)},
  { 10, -1, -1, sizeof(::dtproto::nav_msgs::SteppableAreaTimeStamped)},
};
...
const char descriptor_table_protodef_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "roto\"\263\001\n\rSteppableArea\0224\n\nsteppables\030\001 \003"
  "(\0132 .dtproto.geometry_msgs.Polygon3d\022\030\n\020"
  "steppables_count\030\002 \001(\r\0226\n\014unsteppables\030\003"
  " \003(\0132 .dtproto.geometry_msgs.Polygon3d\022\032"
  "\n\022unsteppables_count\030\004 \001(\r\"s\n\030SteppableA"
  "reaTimeStamped\022(\n\006header\030\001 \001(\0132\030.dtproto"
  ".std_msgs.Header\022-\n\004area\030\002 \001(\0132\037.dtproto"
  ".nav_msgs.SteppableAreab\006proto3"
  ;
...
const ::_pbi::DescriptorTable descriptor_table_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto = {
    false, false, 431, descriptor_table_protodef_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto,
    "dtProto/nav_msgs/SteppableArea.proto",
    &descriptor_table_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto_once, descriptor_table_dtProto_2fnav_5fmsgs_2fSteppableArea_2eproto_deps, 2, 2,
...
void SteppableArea::clear_steppables() {
  _impl_.steppables_.Clear();
}
void SteppableArea::clear_unsteppables() {
  _impl_.unsteppables_.Clear();
}
...
SteppableArea::SteppableArea(const SteppableArea& from)
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.unsteppables_){from._impl_.unsteppables_}
    , decltype(_impl_.steppables_count_){}
    , decltype(_impl_.unsteppables_count_){}
    , /*decltype(_impl_._cached_size_)*/{}};

  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::memcpy(&_impl_.steppables_count_, &from._impl_.steppables_count_,
    static_cast<size_t>(reinterpret_cast<char*>(&_impl_.unsteppables_count_) -
    reinterpret_cast<char*>(&_impl_.steppables_count_)) + sizeof(_impl_.unsteppables_count_));
...
inline void SteppableArea::SharedCtor(
  ...
  new (&_impl_) Impl_{
    ...
    , decltype(_impl_.unsteppables_){arena}
    , decltype(_impl_.steppables_count_){0u}
    , decltype(_impl_.unsteppables_count_){0u}
    , /*decltype(_impl_._cached_size_)*/{}
  };
...
inline void SteppableArea::SharedDtor() {
  ...
  _impl_.unsteppables_.~RepeatedPtrField();
}
...
// @@protoc_insertion_point(message_clear_start:dtproto.nav_msgs.SteppableArea)
  ...
  _impl_.steppables_.Clear();
  _impl_.unsteppables_.Clear();
  ::memset(&_impl_.steppables_count_, 0, static_cast<size_t>(
      reinterpret_cast<char*>(&_impl_.unsteppables_count_) -
      reinterpret_cast<char*>(&_impl_.steppables_count_)) + sizeof(_impl_.unsteppables_count_));
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 26)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(_internal_add_unsteppables(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<uint8_t>(tag) == 32)) {
          _impl_.unsteppables_count_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint32(&ptr);
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
...
uint8_t* SteppableArea::_InternalSerialize(
  ...
  // repeated .dtproto.geometry_msgs.Polygon3d unsteppables = 3;
  for (unsigned i = 0,
      n = static_cast<unsigned>(this->_internal_unsteppables_size()); i < n; i++) {
    const auto& repfield = this->_internal_unsteppables(i);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
        InternalWriteMessage(3, repfield, repfield.GetCachedSize(), target, stream);
  }

  // uint32 unsteppables_count = 4;
  if (this->_internal_unsteppables_count() != 0) {
    target = stream->EnsureSpace(target);
    target = ::_pbi::WireFormatLite::WriteUInt32ToArray(4, this->_internal_unsteppables_count(), target);
  }
...
// @@protoc_insertion_point(message_byte_size_start:dtproto.nav_msgs.SteppableArea)
  ...
  // repeated .dtproto.geometry_msgs.Polygon3d unsteppables = 3;
  total_size += 1UL * this->_internal_unsteppables_size();
  for (const auto& msg : this->_impl_.unsteppables_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
  ...
  // uint32 unsteppables_count = 4;
  if (this->_internal_unsteppables_count() != 0) {
    total_size += ::_pbi::WireFormatLite::UInt32SizePlusOne(this->_internal_unsteppables_count());
  }
...
void SteppableArea::MergeImpl(::PROTOBUF_NAMESPACE_ID::Message& to_msg, const ::PROTOBUF_NAMESPACE_ID::Message& from_msg) {
  ...
  _this->_impl_.unsteppables_.MergeFrom(from._impl_.unsteppables_);
  if (from._internal_steppables_count() != 0) {
    _this->_internal_set_steppables_count(from._internal_steppables_count());
  }
  if (from._internal_unsteppables_count() != 0) {
    _this->_internal_set_unsteppables_count(from._internal_unsteppables_count());
  }
...
void SteppableArea::InternalSwap(SteppableArea* other) {
  ...
  _impl_.unsteppables_.InternalSwap(&other->_impl_.unsteppables_);
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(SteppableArea, _impl_.unsteppables_count_)
      + sizeof(SteppableArea::_impl_.unsteppables_count_)
      - PROTOBUF_FIELD_OFFSET(SteppableArea, _impl_.steppables_count_)>(
          reinterpret_cast<char*>(&_impl_.steppables_count_),
          reinterpret_cast<char*>(&other->_impl_.steppables_count_));
}
